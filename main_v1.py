    ...
    for element in elements:
        if isinstance(element, Table):
            ...
            if table_title in REQUIRED_TABLES:
                ...
                print(f"Table found but title '{table_title}' not in required tables.")
            ...
            # Handle cases where the element doesn't have 'text' or is of different type
            previous_text = ""
